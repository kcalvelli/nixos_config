...
3. For WiFi: Run `nmtui` to configure network
4. Run `install` to start the automated installer
...
- Run script directly: `./nixos_config/scripts/install-axios.sh`
...
- [Installer Script](../scripts/install-axios.sh) - Script source
